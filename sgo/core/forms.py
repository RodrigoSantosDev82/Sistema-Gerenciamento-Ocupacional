...
from .models import Funcao, Exame, Risco, TipoRisco, Setor, Grupo, GrupoExame, GrupoFuncao, GrupoRisco,Treinamento, TipoExame
from .models import Coordenador, Empregado, Atendimento, AtendimentoExame, AtendimentoRisco, GrupoTreinamento
...
class GrupoTreinamentoForm(ModelForm):
    class Meta:
