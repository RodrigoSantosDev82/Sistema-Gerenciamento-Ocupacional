...
from .views import lista_treinamentos, treinamento_novo, treinamento_update, treinamento_delete
from .views import lista_grupos, grupo_novo, grupo_update, grupo_delete, grupofuncao_novo, grupofuncao_delete, gruporisco_novo, grupotreinamento_novo
from .views import lista_empregados, empregado_novo, empregado_update, load_funcoes, load_grupos, grupotreinamento_delete
...
urlpatterns = [
    ...
    path('lista_treinamentos', lista_treinamentos, name='lista_treinamentos'),
    path('treinamento_novo', treinamento_novo, name='treinamento_novo'),
    path('treinamento_update/<int:id>', treinamento_update, name='treinamento_update'),
    path('treinamento_delete/<int:id>', treinamento_delete, name='treinamento_delete'),
    ...
    path('grupotreinamento_novo/<int:id>', grupotreinamento_novo, name='grupotreinamento_novo'),
    path('grupotreinamento_delete/<int:id>', grupotreinamento_delete, name='grupotreinamento_delete'),
